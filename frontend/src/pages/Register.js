...
export default function Register() {
  ...
  const handleSubmit = () => {
    if (!formData.username)
      return setBackendResponse("Please enter your username");
        ...
        <div className="mt-6 bg-white shadow-md rounded-lg text-left">
          ...
          <div className="px-8 py-6">
            ...
            <input
              ...
              placeholder="Email"
              className="border w-full h-5 px-3 py-5 mt-2 text-gray-900 hover:outline-none 
            ...
            <input
              ...
              className="border w-full h-5 px-3 py-5 mt-2 text-gray-900
